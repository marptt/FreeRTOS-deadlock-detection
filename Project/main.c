...
int main( void )
{
    ...
    parameter. */
    xTaskCreate( vContinuousProcessingTask, "ContinuousTask 1", 1000, (void*)pcTextForTask1, 1, NULL );
    /* Create the second task at priority 1. */
    xTaskCreate( vContinuousProcessingTask, "ContinuousTask 2", 1000, (void*)pcTextForTask2, 1, NULL );
